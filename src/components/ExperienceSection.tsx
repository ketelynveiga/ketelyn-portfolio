...
const experiences = [
  ...
  },
  {
    ...
    shortDescription:
      "automação de processos, workflows personalizados e integrações B2B",
    tabs: {
      contexto: {
        title: "Problema de negócio",
        content:
          "Empresas utilizavam processos operacionais manuais ou pouco padronizados, o que gerava ineficiência, retrabalho e dificuldade de escalar operações críticas. O desafio era automatizar processos e workflows personalizados, garantindo aderência às regras de negócio, flexibilidade para diferentes clientes e integração com sistemas externos, em especial em contextos financeiros e regulados.",
        users: [
          "Clientes B2B da plataforma",
          "Times operacionais e financeiros",
          "Áreas de TI e negócio dos clientes",
          "Times internos de produto e desenvolvimento",
        ],
        restrictions: [
          "Processos altamente customizados por cliente",
          "Dependência de regras de negócio complexas",
          "Necessidade de flexibilidade técnica sem comprometer estabilidade",
          "Integrações com sistemas externos e APIs",
          "Contextos com exigências de compliance",
        ],
      },
      papel: {
        title: "Meu papel",
        items: [
          "Atuação na análise e tradução de demandas de negócio em soluções funcionais viáveis",
          "Levantamento e documentação de requisitos para automação de processos e workflows, utilizando BPMN",
          "Interface constante entre clientes, stakeholders internos e times técnicos",
          "Apoio à definição de fluxos, regras de negócio e decisões técnicas",
          "Contribuição para soluções escaláveis, conciliando usabilidade e restrições técnicas",
        ],
      },
      processo: {
        title: "Processo",
        items: [
          "Levantamento de requisitos junto a usuários e stakeholders",
          "Modelagem de processos e workflows personalizados em BPMN",
          "Desenvolvimento de protótipos no Figma para validação de soluções",
          "Análises exploratórias em banco de dados para apoiar decisões e automações",
          "Alinhamentos frequentes com stakeholders para redução de retrabalho",
          "Acompanhamento de testes e homologações junto a usuários e desenvolvimento",
        ],
      },
      entregaveis: {
        title: "Entregáveis",
        items: [
          "Requisitos funcionais e documentação detalhada de processos",
          "Modelos de workflows automatizados em BPMN",
          "Protótipos funcionais para validação de fluxos",
          "Relatórios visuais e documentação funcional para o time técnico",
          "Orientações técnicas para customizações via JavaScript",
          "Apoio à definição de integrações via APIs e sistemas externos",
        ],
      },
      resultados: {
        title: "Resultados",
        items: [
          "Automação de processos internos com redução de tempo operacional",
          "Padronização de fluxos e aumento da eficiência operacional",
          "Maior clareza técnica e funcional para o time de desenvolvimento",
          "Soluções mais flexíveis e adaptáveis às necessidades dos clientes",
          "Melhoria da interoperabilidade entre sistemas por meio de boas práticas de integração",
        ],
      },
    },
  },
