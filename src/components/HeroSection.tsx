      ...
      <div className="container-custom relative z-10 py-24 md:py-32">
        <div className="grid grid-cols-2 gap-6 md:gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              Sou Kételyn Veiga, Product Manager com atuação em produtos digitais B2B e B2C, focada em transformar estratégia, tecnologia e dados em soluções claras, escaláveis e mensuráveis.
            </motion.p>
